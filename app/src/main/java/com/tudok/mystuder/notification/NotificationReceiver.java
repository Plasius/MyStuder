...
import com.tudok.mystuder.activity.MainActivity;
...
public class NotificationReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        List<com.tudok.mystuder.database.Class> classes = Database.getInstance(context).classDAO().getClassesByDay(Constants.DAYS_OF_THE_WEEK[calendar.get(Calendar.DAY_OF_WEEK)-1]);

        for(com.tudok.mystuder.database.Class cls : classes){
